    ...
    <section className="relative pt-24 pb-14 bg-background overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-[5%] text-center">
        <motion.p
          ...
          className="font-sans tracking-[0.3em] uppercase mb-4 font-semibold text-sm text-accent">
        ...
        <motion.p
          ...
          className="font-sans text-[15px] max-w-[520px] mx-auto leading-relaxed text-primary-foreground">
