...
import { Calendar, Clock, ArrowLeft, Tag, ChevronRight, List } from 'lucide-react';
...
export function ClassicListPostLayout({ post, readTime, publishedDate, author, relatedPosts }: LayoutProps) {
  ...
  return (
    <>
      ...
      {/* Bold numbered hero banner */}
      <section className="relative bg-gradient-to-br from-primary/10 via-background to-accent/5 pt-20 pb-16">
      ...
      {/* Numbered items sidebar + content */}
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="flex gap-8 lg:gap-12 max-w-5xl mx-auto">
          {/* Quick jump sidebar */}
        ...
        <section className="py-16 md:py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-10">
              <h2 className="text-2xl md:text-3xl font-serif font-medium text-foreground">You May Also Enjoy</h2>
