...
import { Calendar, Clock, ArrowLeft, Tag, ChevronRight, ShieldQuestion, XCircle, CheckCircle2 } from 'lucide-react';
...
export function MythDebunkerLayout({ post, readTime, publishedDate, author, relatedPosts }: LayoutProps) {
  ...
  const mythCount = headings.filter(h => h.level === 2).length;
  ...
  return (
    <>
      ...
      {/* Content with myth-styled headings */}
        ...
        <section className="py-16 md:py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-10">
              <h2 className="text-2xl md:text-3xl font-serif font-medium text-foreground">More Myth Busters</h2>
