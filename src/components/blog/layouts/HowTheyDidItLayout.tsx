...
import { Calendar, Clock, ArrowLeft, Tag, ChevronRight, Users } from 'lucide-react';
...
export function HowTheyDidItLayout({ post, readTime, publishedDate, author, relatedPosts }: LayoutProps) {
  ...
  return (
    <>
      ...
      {/* Content with strategy cards feel */}
        ...
        <section className="py-16 md:py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-10">
              <h2 className="text-2xl md:text-3xl font-serif font-medium text-foreground">More Success Stories</h2>
