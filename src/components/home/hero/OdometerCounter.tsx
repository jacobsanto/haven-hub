...
export function OdometerCounter({ value, total, reduced }: OdometerCounterProps) {
  ...
  if (reduced) {
    return (
      <span className="text-sm font-sans tracking-wider text-foreground/70">
        {padded} / {totalPadded}
      </span>
    );
  }
  ...
  return (
    <span className="text-sm font-sans tracking-wider text-foreground/70 flex items-center gap-0.5">
