      ...
      <div className="container mx-auto px-4">
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-[clamp(28px,3vw,40px)] font-semibold text-[#f0ece4] leading-[1.15] mb-5">
              Book Direct,<br />Live <em className="font-normal text-accent not-italic">Better</em>
            </h2>
            <p className="font-sans text-sm text-[#6b6560] leading-[1.7]">
            ...
            {perks.map((perk, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#15151f] border border-white/[0.06] rounded-xl p-6 hover:border-accent/40 transition-colors group"
                >
                  <div className="text-accent mb-3">
                    <Icon size={20} />
                  </div>
                  <p className="font-serif text-[15px] font-semibold text-[#f0ece4] mb-1">{perk.title}</p>
                  <p className="font-sans text-xs text-[#6b6560]">{perk.desc}</p>
                </motion.div>
              );
            })}
          </div>
